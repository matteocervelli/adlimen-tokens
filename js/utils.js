...
export function deepMerge(target, ...sources) {
  ...
  if (source === undefined || source === null) return deepMerge(target, ...sources);
  if (target === null || target === undefined) return deepMerge({}, source, ...sources);
